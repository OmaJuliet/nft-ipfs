...
contract Juls is ERC721Enumerable, Ownable {
    ...
    /**
        ...
        * name in our case is Juls and symbol is JUL.
        * Constructor for LW3P takes in the baseURI to set _baseTokenURI for the collection.
        */
    // constructor (string memory baseURI) ERC721("Juls", "JUL") {
    constructor (string memory baseURI) ERC721("Juls", "JUL") Ownable(msg.sender){
    ...
    */
    function mint() public payable onlyWhenNotPaused {
        require(tokenIds < maxTokenIds, "Exceed maximum Juls supply");
